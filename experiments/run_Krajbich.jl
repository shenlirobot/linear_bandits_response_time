...
function run_1_subject(subject_idx::Int64, base_path::String, SSM_path::String, result_path::String, num_subjects::Int64)
    ...
    θ, arms, queries, armIdxPair_2_queryIdx, queryIdx_2_armIdxPair, problem_name = problem8_Krajbich(subject_idx, SSM_path, seed_problem_definition)
